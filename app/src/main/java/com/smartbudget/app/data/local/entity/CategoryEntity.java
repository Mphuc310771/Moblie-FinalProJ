 ...
 * - name: Display name of the category (e.g., "Ăn uống", "Di chuyển")
...
public class CategoryEntity implements Serializable {
     ...
     * Examples: "Ăn uống", "Di chuyển", "Lương"
     ...
     * Typically an emoji character (e.g., "🍔", "🚗", "💰")
     ...
     * 
     * @return "Chi tiêu" for expense, "Thu nhập" for income
     */
